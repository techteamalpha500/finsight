#!/usr/bin/env python3
"""
Individual Deployment Script for expenses-api Lambda
This script handles deployment of only the expenses-api Lambda function
"""
...
def build_expenses_api_package():
    """Build expenses-api Lambda package with dependencies"""
    print("🔧 Building expenses-api Lambda package...")
    
    # Paths for expenses-api
    ...
    print(f"✅ expenses-api package built successfully: {zip_file}")
    return zip_file

def deploy_terraform():
    """Deploy only the expenses-api Lambda using Terraform"""
    print("🚀 Deploying expenses-api Lambda with Terraform...")
    ...
    run_command(["terraform", "plan", "-target=aws_lambda_function.expenses_api"])
    
    # Apply deployment
    print("🚀 Applying Terraform deployment...")
    run_command(["terraform", "apply", "-target=aws_lambda_function.expenses_api", "-auto-approve"])
    
    print("✅ expenses-api Lambda deployed successfully!")

def main():
    """Main deployment function"""
    print("🚀 Starting expenses-api Lambda deployment...")
    print("=" * 60)
    ...
    build_expenses_api_package()
    
    # Deploy with Terraform
    deploy_terraform()
    
    print("=" * 60)
    print("🎉 expenses-api Lambda deployment completed successfully!")
    print("📊 You can now test the expenses API functionality")
